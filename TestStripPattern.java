...
public class TestStripPattern {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // begin ART
        System.out.println("=== Strip pattern tests with ART for TCS/TCP ===");
        ...
        for(i = 0; i < repetition; i++){
            ...
            while(condition){
                ...
                result1 = SUTPatterns.stripOracle(tc1, tc2);
                result2 = SUTPatterns.stripSeeded(tc1, tc2);
        ...
        // begin Random
        System.out.println("=== Strip pattern tests with Random TCS ===");
        System.out.println();
        totalTimeS  = 0;
        totalTimeES  = 0;
        evalTCS.initializeEvaluation();
