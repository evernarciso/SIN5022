...
*** Passo1: Clonar o repositório
   ...
   git clone -b docs https://github.com/evernarciso/SIN5022.git
   #+END_SRC
...
*** Compilando as classes java   
   ...
   ls softwareTesting/*.class
   #+END_SRC

   #+RESULTS:
   - ("softwareTesting/ARTforAlphanumeric.class")
   - ("softwareTesting/ARTforDouble.class")
   - ("softwareTesting/ARTforInteger.class")
   - ("softwareTesting/DistanceFunctions.class")
   - ("softwareTesting/Evaluation.class")
   - ("softwareTesting/RandomAlphanumericGen.class")
   - ("softwareTesting/SUTPatterns.class")
   - ("softwareTesting/SUTSIR.class")
   - ("softwareTesting/TestBlockPattern.class")
   - ("softwareTesting/TesteJaccard.class")
   - ("softwareTesting/TestStripPattern.class")
   - ("softwareTesting/TestSUTSIR.class")

   A saída deste comando são as classes compiladas abaixo.. que são
   geradas no diretório softwareTesting

*** Executando o experimento
   Conforme explicado anteriormente, pra reproduzir o experimento
   basta rodar as três classes que contém o método main
   
   + TestBlockPattern.java
   + TestStripPattern.java
   + TestSUTSIR.java 

   #+NAME:  java  -cp . softwareTesting.TestSUTSIR
   #+BEGIN_SRC sh :exports both 
   cd /home/wagner/projetos/SIN5022/
   java  -cp . softwareTesting.TestSUTSIR
   java  -cp . softwareTesting.TestBlockPattern
   java  -cp . softwareTesting.TestStripPattern   
   #+END_SRC
